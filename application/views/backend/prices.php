    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Rental Prices <button type="button" id="add_price" class="btn btn-sm btn-primary float-right">Add <i class="bi bi-plus-circle ms-1"></i></button></h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><div class="d-flex justify-content-center">
                        ...
                        <a title="Edit Record" href="javascript:void(0)" record-data="<?=$row['id']?>" class="edit-price-record text-warning float-right mx-2"><i class="bi bi-pencil-square"></i></a>
