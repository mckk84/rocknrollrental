    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Bikes <button type="button" data-bs-toggle="modal" data-bs-target="#add-bike" class="btn btn-primary float-right">Add <i class="bi bi-plus-circle ms-1"></i></button></h5>
