                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><div class="d-flex justify-content-center">
                        ...
                        <a title="Edit Record" href="javascript:void(0)" record-data="<?=$row['id']?>" class="edit-manaufacturer-record text-warning float-right mx-2"><i class="bi bi-pencil-square"></i></a>
