    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Bike Types</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Bike Types <button type="button" class="new-bike-type btn btn-sm btn-primary float-right">Add <i class="bi bi-plus-circle ms-1"></i></button></h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><div class="d-flex justify-content-center">
                        ...
                        <a title="Edit Record" href="javascript:void(0)" record-data="<?=$row['id']?>" class="edit-biketype-record text-warning float-right mx-2"><i class="bi bi-pencil-square me-1"></i></a>
