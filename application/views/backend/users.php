                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><div class="d-flex justify-content-start">
                        <a title="Edit Record" href="javascript:void(0)" record-data="<?=$row['userId']?>" class="edit-user-record text-warning float-right mx-2"><i class="bi bi-pencil"></i></a>
                        <a title="Delete Record" href="javascript:void(0)" record-data="<?=$row['userId']?>" class="delete-record text-danger float-right mx-2"><i class="bi bi-trash"></i></a>
                      </div></td>
                    </tr>
                     <?php } ?>
                  </tbody>
