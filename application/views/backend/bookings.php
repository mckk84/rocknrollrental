    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Bookings <a href="<?=base_url('admin/Bookings/new')?>" class="btn btn-sm btn-primary float-right">New <i class="bi bi-plus-circle ms-1"></i></a></h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><div class="d-flex justify-content-center">
                        ...
                        <?php if( $row['status'] == 0 && $user['user_type'] == 'Admin' ){?>
                          <a title="Cancel Order" href="javascript:void(0)" record-data="<?=$row['id']?>" class="cancel-booking-record text-danger float-right fs-6 mx-2"><i class="bi bi-x-square me-1"></i></a>
                        <?php } ?>
